...
<strong>第一，剩余预算充足或未消耗完之前，对问题的发生要有容忍度。</strong>
...
- <strong>用户满意度</strong>。英文就是Customer Satisfaction，可以理解为用户感受和体验如何。这个信息可以通过真实和虚拟渠道获得。真实渠道如客服投诉、客户访谈和舆情监控获取；虚拟渠道如真机模拟拨测。我们用满意度高（High）和低（Low）来表示。
