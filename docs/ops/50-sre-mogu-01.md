...
![Intro](../images/sre/mogu/intro.jpg)
...
![Intro](../images/sre/mogu/intro-v2.jpg)
...
好了，按照以终为始的思路，SRE要实现的目标就是“提升MTBF、降低MTTR”，从这个角度出发，我们再次认识到一定要把**SRE作为一个体系化的工程来建设**，因为单纯在某些技术点上发力是没有多大意义的。
